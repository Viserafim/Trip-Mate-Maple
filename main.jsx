...
import {CalendarDays, ChevronRight, Clock3, MapPin, Plus, ArrowLeft, Check, Map, Home, Navigation, Pencil, Trash2, ExternalLink, Menu, X, MoreHorizontal, Search, Info} from 'lucide-react';
import './styles.css';
...
function matchesFilter(day, filter){
 ...
 if(filter==='Toronto') return day.city==='Toronto' || /toronto|cn tower|ripley|rom|yorkville|casa loma|spadina|blue jays/i.test(day.title+' '+day.activities.map(a=>a.place).join(' '));
